...
import com.example.food_android.Adaptor.CartListAdapter;
...
public class CartListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        supourtBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(CartListActivity.this , SuportActivity.class));
            }
        });
    ...
    private void initView() {
        ...
        deliveryTxt=findViewById(R.id.delivaryTxt);
